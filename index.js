...
const aksesItems = [
  ...
  { id: 'myrepublic', label: 'MyRepublic', icon: 'img/dashboard/akses-cepat/transfer.svg', category: 'INTERNET' },
  { id: 'cbn', label: 'CBN', icon: 'img/dashboard/akses-cepat/transfer.svg', category: 'INTERNET' },
  { id: 'iconnect', label: 'Iconnect', icon: 'img/dashboard/akses-cepat/transfer.svg', category: 'INTERNET' },
